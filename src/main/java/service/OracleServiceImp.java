...
public class OracleServiceImp implements BaseTelecomService {
    ...
    public boolean verifyUser(final String phoneId, final String password) {
        ...
        boolean userexsist =
                (Boolean) oracleJdbcTemplate.execute(new CallableStatementCreator() {
    ...
    public JSONObject getBalance(final String phoneId) {
        ...
        Map<String,Object> Userbanance =
                oracleJdbcTemplate.execute(new CallableStatementCreator() {
                    public CallableStatement createCallableStatement(Connection connection) throws SQLException {
    ...
    public List<JSONObject> getRechargeRecord(final String phoneId, final Integer begin) {
        ...
        List<JSONObject> rechargeRecords = oracleJdbcTemplate.execute(new CallableStatementCreator() {
            public CallableStatement createCallableStatement(Connection connection) throws SQLException {
